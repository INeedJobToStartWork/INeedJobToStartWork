...
export default [
	{
		...
		"@stylistic/js/array-bracket-spacing": ["error", "never", { "arraysInArrays": false, "singleValue": false }],
		"@stylistic/js/array-element-newline": ["error", { "multiline": true, "minItems": 50 }],
