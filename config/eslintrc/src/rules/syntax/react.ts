...
export default [{
	...
	rules: {
		...
		"@EslintReact/function-component-definition": ["error",
			{
		...
		"@EslintReact/jsx-key": ["error",
			{
				checkFragmentShorthand: false, warnOnDuplicates: true
			}],
		...
		"@EslintReact/jsx-no-bind": ["error",
			{
				allowArrowFunctions: true, allowFunctions: true, allowBind: false
			}],
		...
		"@EslintReact/jsx-no-literals": ["error",
			{
				noStrings: true,
				allowedStrings: true,
				ignoreProps: true,
		...
		"@EslintReact/jsx-pascal-case": ["error",
			{
		...
		"@EslintReact/jsx-sort-props": ["error",
			{
				callbacksLast: false,
