...
export default [{
	...
	rules: {
		...
		"@EslintJSXA11/img-redundant-alt": [2,
			{
				components: ["Image"],
		...
		"@EslintJSXA11/media-has-caption": [2,
			{
				audio: ["Audio"],
				video: ["Video"],
				track: ["Track"]
		...
		"@EslintJSXA11/no-noninteractive-element-to-interactive-role": ["error",
			{
				ul: ["listbox",
					"menu",
					"menubar",
		...
		"@EslintJSXA11/no-static-element-interactions": ["error",
			{
				handlers: ["onClick",
					"onMouseDown",
					"onMouseUp",
